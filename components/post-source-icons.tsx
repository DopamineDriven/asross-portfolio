				...
				<li className='align-middle'>
					...
					{github === '' ? (
						...
						<a
							...
							target='__blank'
							href={github}
							className='bg-portfolio text-black  hover:bg-iconHover leading-normal transition-all transform delay-300 duration-1000 ease-in-out text-lg inline-block text-center items-center align-middle justify-center w-8 h-8 mx-1 my-2 pt-threeHalves rounded-full focus:outline-none'
						>
							{github === '' ? (
								<></>
							) : (
