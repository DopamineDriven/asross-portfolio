			...
			<Container>
				<div className='pb-1  min-w-nineTenths w-nineTenths'>
					{preview ? (
						...
						<>
							<a className='block min-w-nineTenths w-nineTenths prose mx-auto justify-start text-left flex-grow text-black font-somaRoman uppercase font-bold pt-1 text-6xl'>
