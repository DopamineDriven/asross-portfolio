...
const AboutExcerpt = ({ excerpt, slug }: AboutExcerptProps) => {
	return (
		<div className='text-oneFiveBlack dark:text-white cursor-default hover:text-fiveOBlack dark:hover:text-eaWhite transition-all transform duration-10000 -translate-y-1 animate-pulse'>
